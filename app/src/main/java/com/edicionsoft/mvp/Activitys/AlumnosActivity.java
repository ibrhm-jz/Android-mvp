...
public class AlumnosActivity extends AppCompatActivity implements ViewAlumnos {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addAlumno =findViewById(R.id.btn_agregar);

        key= getIntent().getExtras().getString("key");
        addAlumno.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AlumnosActivity.this, AgregarAlumnos.class);
        ...
        if(key.equals("c2ad7aa18de9204deced845d3cc56dae2cc74520")){
            ...
            lvone.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    viewAlumno(ids.get(position).toString(),nombre.get(position).toString(),ap.get(position).toString(),am.get(position).toString(),edad.get(position).toString(),
    ...
    private void viewAlumno(final String id,String nombre, String apellidop,String apellidom,String edad,String sexo,String carrera,String direccion){
        ...
        btnActualiza=viewClientes.findViewById(R.id.actualizar_btn);
        ...
        params.put("nombre", nombreEt.getText());
        params.put("apellidoPaterno", apellidopEt.getText());
        params.put("apellidoMaterno", apellidomEt.getText());
        params.put("edad", edadEt.getText());
        params.put("carrera", carreraEt.getText());
        params.put("direccion", direccionEt.getText());
        params.put("sexo", sexoEt.getText());
        ...
        btnActualiza.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mPresenter.updateAlumnos(id,key,params);
            }
        });
